...
export default function PartagerCarnetsScreen() {
  ...
  const partager = async () => {
    ...
    try {
      const r = await partagerEnMasse(numero, selection);
      setResultat(
...
const styles = StyleSheet.create({
  ...
  liste: { gap: spacing[2], marginBottom: spacing[5] },
  item: { flexDirection: 'row', alignItems: 'center', gap: spacing[3], borderRadius: radius.md },
