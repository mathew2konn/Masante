 ...
 * Décision propriétaire G1 : accès portail = rôle contrôleur plateforme ou `ministere`. Or aucun compte n'en
...
class ControleurPlateformeSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $this->command?->info('Contrôleur plateforme (dév) : 0709090909 / Controle@2026! (rôle admin_ivoirsante)');
    }
}
