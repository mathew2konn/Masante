...
- **P3 Recherche établissements/médecins + fiches + carte OSM (offline)** : PROCHAIN (module 3 §17). Géoloc 3A/3B déjà « implémenté et prouvé » → démarrage par Phase 0 d'audit ; l'incrément neuf = l'offline.
