...
| **P6.8** | Référentiels transverses (CDC_09 §8) | [GUIDE_TEST_TRANSVERSES.md](GUIDE_TEST_TRANSVERSES.md) | **Partie 1** spécialités médicales (§1.1–1.9) · **Partie 2** vaccins + calendrier vaccinal (V1–V36, écran mobile) · **Partie 3** maladies (CIM) : gardes du moteur, gouvernance, trois miroirs, antécédent, alerte, portail, mobile · **Partie 4** assurances et organismes agréés (§4.1–4.13) : couvertures cumulables, provenance déclarée, gardes du moteur, gouvernance, deux miroirs, carte CMU dérivée, portail, mobile · partie 5 à venir (numéros d'urgence) |
