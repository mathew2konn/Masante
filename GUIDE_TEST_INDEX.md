...
| **P6.3 / P6.4** | Référentiels nationaux (CDC_09) | [GUIDE_TEST_REFERENTIELS.md](GUIDE_TEST_REFERENTIELS.md) | **Partie 1** socle (§1–8) · **Partie 2** établissements (§2.1–2.8) · **Partie 3** villes et géolocalisation (§3.1–3.8) |
...
|--------|---------|-------------|
| **P6.4c** | Images des établissements (logo, photos) | **partie 4** de `GUIDE_TEST_REFERENTIELS.md` |
| **P6.4d** | Écrans du portail alignés sur le schéma enrichi (+ `ville`, `forme_juridique`) | **partie 5** de `GUIDE_TEST_REFERENTIELS.md` |
