...
| Sujet | Document |
|---|---|
| Modèle économique, paliers, barème | `claude_Modele_Economique_et_Partenariats_MaSante.md` |
| Essai 30 jours, solde unique, bascule Palier 0 | `claude/Amendement_Essai_et_Recouvrement_MaSante.md` |
| Schéma de facturation (v2.1) | `claude/Prompt_ClaudeCode_Tables_Facturation_MaSante_v2.md` |
| Règles d'imputation et de recouvrement, produites par la Phase 4 du schéma | `docs/REGLES_RECOUVREMENT_PARTENAIRE.md` (Laravel, créé par le lot ci-dessus) |
| Arbitrages GeniusPay (B1–B7), montage A, machine à états | `claude/Arbitrage_Audit_Phase0_GeniusPay.md` |
| Prélèvement à la source — pourquoi ce n'est pas fait aujourd'hui | `claude/Prelevement_Commission_a_la_Source.md` |
